...
typedef struct ldr_read_fmi2Component_s* fmi2Component;
...
typedef struct ldr_read_fmi2Component_s {
  ...
  void* extObjs[3];
} ldr_read_fmi2Component;

ldr_read_fmi2Component ldr_read_component = {
  .fmi2RealVars = {
    0.0 /*adc._y*/,
...
fmi2Component ldr_read_fmi2Instantiate(fmi2String name, fmi2Type ty, fmi2String GUID, fmi2String resources, const fmi2CallbackFunctions* functions, fmi2Boolean visible, fmi2Boolean loggingOn)
{
  static int initDone=0;
  if (initDone) {
    return NULL;
  }
  return &ldr_read_component;
}

fmi2Status ldr_read_fmi2SetupExperiment(fmi2Component comp, fmi2Boolean toleranceDefined, fmi2Real tolerance, fmi2Real startTime, fmi2Boolean stopTimeDefined, fmi2Real stopTime)
{
  return fmi2OK;
}

fmi2Status ldr_read_fmi2EnterInitializationMode(fmi2Component comp)
{
...
fmi2Status ldr_read_fmi2ExitInitializationMode(fmi2Component comp)
{
  return fmi2OK;
}

static fmi2Status ldr_read_functionODE(fmi2Component comp)
{
}

static fmi2Status ldr_read_functionOutputs(fmi2Component comp)
{
...
fmi2Status ldr_read_fmi2DoStep(fmi2Component comp, fmi2Real currentCommunicationPoint, fmi2Real communicationStepSize, fmi2Boolean noSetFMUStatePriorToCurrentPoint)
{
  comp->currentTime = currentCommunicationPoint;
  /* TODO: Calculate time/state-dependent variables here... */
  ldr_read_functionOutputs(comp);
  return fmi2OK;
}
...
int main(int argc, char **argv)
{
  ...
  fmi2Component comp = ldr_read_fmi2Instantiate("", fmi2CoSimulation, "", "", &cbf, fmi2False, fmi2False);
  if (comp==NULL) {
    return 1;
  }
  ldr_read_fmi2SetupExperiment(comp, fmi2False, 0.0, 0.0, fmi2False, 1.0);
  ldr_read_fmi2EnterInitializationMode(comp);
  // Set start-values? Nah...
  ldr_read_fmi2ExitInitializationMode(comp);
  ...
  while (status == fmi2OK) {
    ...
    status = ldr_read_fmi2DoStep(comp, currentTime, h, fmi2True);
    switch (status) {
      case fmi2Discard:
      case fmi2Error:
      case fmi2Fatal:
